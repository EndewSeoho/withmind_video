...
def Initialization():
    ...
    FD_Net = cv2.dnn.readNetFromCaffe("C:/Users/withmind/Documents/withmind/IM/01_python_pytorch_project/01_python_pytorch_project/video/im_video/models/opencv_ssd.prototxt", "C:/Users/withmind/Documents/withmind/IM/01_python_pytorch_project/01_python_pytorch_project/video/im_video/models/opencv_ssd.caffemodel")
    ...
    Landmark_Net.load_state_dict(torch.load("C:/Users/withmind/Documents/withmind/IM/01_python_pytorch_project/01_python_pytorch_project/video/im_video/models/ETRI_LANDMARK_68pt.pth.tar", map_location=device)['state_dict'])
    ...
    Headpose_Net.load_state_dict(torch.load("C:/Users/withmind/Documents/withmind/IM/01_python_pytorch_project/01_python_pytorch_project/video/im_video/models/ETRI_HEAD_POSE.pth.tar"))

    # Emotion classifier
    Emotion_Net = EmotionNet(num_classes=7).to(device)
    # new_dict = get_state_dict(torch.load("./models/ETRI_Emotion.pth.tar")['state_dict'])
    new_dict = get_state_dict(torch.load("C:/Users/withmind/Documents/withmind/IM/01_python_pytorch_project/01_python_pytorch_project/video/im_video/models/ETRI_EMOTION.pth.tar")['state_dict'])
...
def soundcheck(self):
    ...
    fileroute = 'C:/Users/withmind/Documents/withmind/IM/01_python_pytorch_project/01_python_pytorch_project/video/im_video/'
    filename = 'sound.wav'
